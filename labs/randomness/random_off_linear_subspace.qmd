...
xlab="", ylab="", zlab="")
axes3d(labels = NULL)
normal <- pracma::cross(X[,1], X[,2])
planes3d(a = normal[1], b = normal[2], c = normal[3], alpha = 0.5, col = "dodgerblue")
points3d(y, col = "red", size = 10)
points3d(yhat, col = "blue", size = 10)
segments3d(rbind(y, yhat), col = "black", lwd = 2)
text3d(y, texts = "y", pos = 3, col = "red")
text3d(yhat, texts = "ŷ", pos = 3, col = "blue")
```
